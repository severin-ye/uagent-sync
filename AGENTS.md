...
This project is indexed by GitNexus as **uagent-sync** (1222 symbols, 2867 relationships, 102 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/uagent-sync/context` | Codebase overview, check index freshness |
| `gitnexus://repo/uagent-sync/clusters` | All functional areas |
| `gitnexus://repo/uagent-sync/processes` | All execution flows |
| `gitnexus://repo/uagent-sync/process/{name}` | Step-by-step execution trace |
